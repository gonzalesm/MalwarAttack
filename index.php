...
move_multiple(<?php echo $tab2; ?>);
    ...
    <div class="menu-person">
      <ul class="list-startup">
        <li class="person startup">
          <img src="images/Startup.png" data-name="Startup">
      ...
      <ul class="list-antivirus">
        <li class="person antivirus">
          <img src="images/Antivirus.png" data-name="Antivirus">
      ...
      <ul class="list-intern">
        <li class="person intern">
          <img src="images/Intern.png" data-name="Intern">
      ...
      <ul class="list-dev">
        <li class="person developper">
          <img src="images/Developper.png" data-name="Developer">
